...
import edu.mit.media.prg.arduino.*; 
...
public class MultiStepperControl extends PApplet {
...
public void setMotorSpeed(int motorIndex, float value)
{
...
public void setMotorHome(int motorIndex)
{
...
public void setMotorPosition(int motorIndex, int pos)
{
...
public void defineMotorPos(int motorIndex, int pos)
{
...
public void oscEvent(OscMessage msg) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MultiStepperControl" };
    if (passedArgs != null) {
